...
pangopup-build verify ../target/spec/snv-lookup-contract/bundle | sed -E 's/sha256:[0-9a-f]{64}/sha256:<digest>/' | mustmatch '{"status":"verified","bundle_id":"sha256:<digest>","members_verified":2}'
```
...
```bash
pangopup lookup --bundle ../target/spec/snv-lookup-contract/bundle --variant GRCh38:17:7686072:G:T | sed -E 's/sha256:[0-9a-f]{64}/sha256:<digest>/' | mustmatch '{"assembly":"GRCh38","contig":"chr17","position":7686072,"ref":"G","alt":"T","status":"found","records":[{"gene":"ENSG00000141499","stable_gene":"ENSG00000141499","gene_names":{"symbol":"WRAP53","source":"hgnc","hgnc_id":"HGNC:25522","ncbi_gene_id":55135,"prev_symbols":["WDR79"],"alias_symbols":["FLJ10385","TCAB1"]},"gain_score":"0.35","gain_position":25,"loss_score":"0.00","loss_position":-50},{"gene":"ENSG00000141510","stable_gene":"ENSG00000141510","gene_names":{"symbol":"TP53","source":"hgnc","hgnc_id":"HGNC:11998","ncbi_gene_id":7157,"alias_symbols":["p53","LFS1"]},"gain_score":"0.00","gain_position":-50,"loss_score":"0.00","loss_position":-50}],"source_reference_ambiguities":[],"provenance":{"kind":"precomputed","bundle_id":"sha256:<digest>","source_doi":"10.5281/zenodo.15649338","source_archive_md5":"679ef0b50e511b6102b4b88fbf811108","masked":true,"window":50,"software_version":"0.5.0"}}'
pangopup lookup --bundle ../target/spec/snv-lookup-contract/bundle --variant GRCh38:NC_000017.11:7686072:G:T --gene ENSG00000141499 | rg -o '"contig":"chr17","position":7686072,"ref":"G","alt":"T","status":"found","records":\[\{"gene":"ENSG00000141499","stable_gene":"ENSG00000141499","gene_names":\{"symbol":"WRAP53","source":"hgnc","hgnc_id":"HGNC:25522","ncbi_gene_id":55135,"prev_symbols":\["WDR79"\],"alias_symbols":\["FLJ10385","TCAB1"\]\},"gain_score":"0.35"' | mustmatch like '"contig":"chr17","position":7686072,"ref":"G","alt":"T","status":"found","records":[{"gene":"ENSG00000141499","stable_gene":"ENSG00000141499","gene_names":{"symbol":"WRAP53","source":"hgnc","hgnc_id":"HGNC:25522","ncbi_gene_id":55135,"prev_symbols":["WDR79"],"alias_symbols":["FLJ10385","TCAB1"]},"gain_score":"0.35"'
pangopup lookup --bundle ../target/spec/snv-lookup-contract/bundle --variant GRCh38:chr17:7686072:G:T --gene ENSG00000141510 | rg -o '"records":\[\{"gene":"ENSG00000141510","stable_gene":"ENSG00000141510","gene_names":\{"symbol":"TP53","source":"hgnc","hgnc_id":"HGNC:11998","ncbi_gene_id":7157,"alias_symbols":\["p53","LFS1"\]\},"gain_score":"0.00"' | mustmatch like '"records":[{"gene":"ENSG00000141510","stable_gene":"ENSG00000141510","gene_names":{"symbol":"TP53","source":"hgnc","hgnc_id":"HGNC:11998","ncbi_gene_id":7157,"alias_symbols":["p53","LFS1"]},"gain_score":"0.00"'
```
...
pangopup lookup --bundle ../target/spec/snv-lookup-contract/bundle --variant GRCh38:chr1:3:G:C | rg -o '"status":"mixed","records":\[\{"gene":"ENSG00000000003".*"loss_position":-50\}\],"source_reference_ambiguities":\[\{"gene":"ENSG00000000004"' | rg -o '"status":"mixed"' | mustmatch like '"status":"mixed"'
...
pangopup lookup --bundle "$bundle" --variant GRCh38:chr1:3:G:C --gene ENSG00000000003 | rg -Fq '"status":"found","records":[{"gene":"ENSG00000000003","stable_gene":"ENSG00000000003"'
