...
For the current immutable public release, use the tagged `v0.3.0` script with
`--version 0.3.0`. The only
...
The public v0.3.0 release passed a clean isolated Linux run using the real
