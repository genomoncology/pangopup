...
The accepted implementation passed 116 asset tests, five macOS CLI-boundary tests, `make lint`, `make test`, and `make spec` on macOS. Existing Linux CI remains the Linux execution proof.
