...
- Require a denial of legal advice within the same clause as the term. An unrelated negation in an earlier clause must not satisfy it. Preserve current valid separate-sentence and same-clause denials.
