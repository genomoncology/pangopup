...
Docker image through one native AMD64/ARM64 GHCR index. The public executable identifies application v0.4.0; the public container remains v0.3.0; the repository prepares v0.4.1 as one coherent executable/container candidate without changing scoring assets. It does not yet ship a systemd example or metrics. The CLI interface remains
