...
The authoritative run at clean pushed commit `142787ce82471544a9bb8356b8dc8ef834eef1ca` passed every latency gate. Sparse p50 was 1,663 / 16,222 / 157,189 ns for 1 / 10 / 100 gene-filtered requests. Fixed-v1 p50 was 461 / 4,379 / 41,341 ns. The sparse reader was 3.61 to 3.80 times slower, below the independent ten-times control and the 2,100 / 19,640 / 195,880 ns absolute ceilings. [`planning/artifacts/0133-sparse-index-latency.md`](../planning/artifacts/0133-sparse-index-latency.md) records the host, exact inputs, executable, command, raw report identity, result, and limitations. The result does not cover the sparse reader's different unfiltered traversal or whole-genome throughput. This passes the latency gate only. It does not activate or fully qualify the candidate.
