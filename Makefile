...
PORTABLE_QUALIFICATION := tests/ci-platform-support.sh tests/ci-test-failure-evidence.sh tests/release-help-contract.sh tests/version-consistency-python39.sh
