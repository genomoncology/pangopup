...
PORTABLE_QUALIFICATION := tests/built-executable-currency.sh tests/ci-platform-support.sh tests/ci-service-fixture-evidence.sh tests/ci-test-failure-evidence.sh tests/cli-spawn-cache-isolation.sh tests/release-help-contract.sh tests/spec-cargo-filter-evidence.sh tests/version-consistency-python39.sh
